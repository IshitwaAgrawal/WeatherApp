...
const mapDispatchToProps = (dispatch) => {
  return {
    setCurrentData: (data) =>
      dispatch({ type: actionTypes.SET_CURRENT_DATA, payload: data }),
    setDailyData: (data) =>
      dispatch({ type: actionTypes.SET_DAILY_DATA, payload: data }),
    setHourlyData: (data) =>
      dispatch({ type: actionTypes.SET_HOURLY_DATA, payload: data }),
    setCoordinates: (data) =>
      dispatch({ type: actionTypes.SET_COORDINATES, payload: data }),
    setTimezoneOffset: (data) =>
      dispatch({
        type: actionTypes.SET_TIMEZONE_OFFSET,
        timezone_offset: data,
      }),
    toggleLoading: (data) =>
      dispatch({ type: actionTypes.TOGGLE_LOADING, status: data }),
  };
};
